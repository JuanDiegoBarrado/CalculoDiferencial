...
Sea $x\in A'$, y sea $\{x_n\}_{n \in \mathbb{N}} \subset A: x_n \to x, x_n \neq x$. Veamos que $x \in A$.

Como $\{x_n\}_{n \in \mathbb{N}}$ es sucesión de Cauchy en $A$, y $A$ es completo, $x_n \to x \in A$.
\item \fbox{$\Leftarrow$}. Sabemos que $E$ es completo y $A$ es cerrado y totalmente acotado. Veamos que $A$ es completo.

Sea $\{x_n\}_{n \in \mathbb{N}} \subset A$ una sucesión de Cauchy. Entonces $\{x_n\}_{n \in \mathbb{N}} \subset E$ es sucesión de Cauchy, y como $E$ es completo, $x_n \to x \in E$, y como $A$ es cerrado por hipótesis, $x \in A$.
\end{itemize}

\begin{theo}[Heine - Borel]
$A \subset \mathbb{R}^n \Leftrightarrow A$ es cerrado y acotado.
\end{theo}
...
\item \fbox{$\Leftarrow$}. Sea $A$ cerrado y acotado en $\mathbb{R}^n$. Veamos que $A$ es secuencialmente acotado.

Sea $\{x_m\}_{m \in \mathbb{N}} \subset A$. Entonces, $\{x_m\}_{m \in \mathbb{N}}$ es acotada en $\mathbb{R}^n$. Entonces, $\exists \{y_k\}_{k \in \mathbb{N}} \subset \{x_m\}_{m \in \mathbb{N}}$ parcial convergente en $\mathbb{R}^n$.
$$y_k \to y \in \bar{A} = A$$
