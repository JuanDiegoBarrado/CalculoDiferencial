...
$$d(g \circ f)(x_0) = \left( \frac{\partial (g \circ f)_j}{\partial x_k} (x_0) \right)_{\begin{matrix}
1 \leq j \leq p \\ 1 \leq k \leq n
\end{matrix}}\in M_{p \times n}$$
...
\begin{coro}
Si $f: A \subset \mathbb{R}^n \to \mathbb{R}^m$ diferenciable en el abierto $A$ donde también es convexo y $df = 0$ en $A$, entonces $f$ es constante.
\end{coro}
\begin{demo}
...
\end{theo}
\begin{demo}
La demostración se deja como ejercicio entregable para subir nota.
\end{demo}
...
$$J_f (x_0) = df(x_0) = \begin{pmatrix} \nabla f_1(x_0) \\ \vdots \\ \nabla f_m (x_0)\end{pmatrix} \in M_{m \times n}$$
